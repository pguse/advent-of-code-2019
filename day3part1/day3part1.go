...
func main() {
	...
	// Calculate the minimum Manhatten distance of the common points
	var dist int
	if len(common) != 0 {
		dist = int(math.Abs(float64(common[0].x)) + math.Abs(float64(common[0].y)))
	...
	fmt.Println("Minimum Manhatten Distance: ", dist)
